...
public interface IRepositorioIndicadores
{
    ...
    /// <summary>Faturamento de cada garçom com data no intervalo [inicio, fim) (<c>vw_desempenho_garcom_turno</c>).</summary>
    Task<Dictionary<int, decimal>> ObterFaturamentoPorGarcom(DateOnly inicio, DateOnly fim);
}
