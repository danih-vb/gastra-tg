...
| D14 | **A sugestão de alocação se explica ao Metre com faixas, não com valores** (#235) | Mostrar o faturamento por turno de cada garçom; não explicar nada além da regra geral | Sem explicação por garçom, a sugestão parece caixa-preta e o Metre ajusta no escuro. Com o valor em reais, a tela daria ao Metre um indicador de desempenho que ele não consulta em lugar nenhum (os relatórios por garçom são só do Gerente). A faixa em relação à equipe do turno (abaixo, na média, acima, com 10% de tolerância) é o bastante para entender a escolha da RN03 | Os fatores são recalculados do histórico até a véspera a cada consulta, então a explicação não se perde ao recarregar. Só Metre e Gerente recebem; o Garçom, que também consulta o salão, recebe os campos vazios |
